...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact SpeakAI</title>

        <meta
          name="description"
          content="Contact SpeakAI for feedback, support, collaborations, and interview coaching inquiries."
        />

        <link rel="canonical" href="https://speakai.in/contact" />
      </Helmet>
        ...
        <section className="grid md:grid-cols-3 gap-4 mt-10">
          ...
          <div className="card text-center">
            ...
            <p className="text-muted mt-1">
              Partnerships & interview workshops
            </p>
