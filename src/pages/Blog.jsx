    ...
    <main className="container-p py-10">
      ...
      <div className="max-w-3xl">
        ...
        <p className="text-muted mt-4 text-lg">
          Frontend interview preparation, communication tips, React, JavaScript,
          AI tools, and career growth.
        </p>
      </div>
        ...
        {blogs.map((blog) => (
          ...
          >
            ...
            <div className="mt-6">
              ...
              <p className="text-muted mt-4 line-clamp-3">{blog.description}</p>
